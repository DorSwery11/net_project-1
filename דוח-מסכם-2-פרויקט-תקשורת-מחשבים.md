...
![screen-shot-3](screen-shot-3.jpeg)
## 5. ניתוח תעבורה של היישום (Wireshark)


לכדנו את התעבורה עם Wireshark בממשק Loopback ושמרנו בקובץ `chat_traffic.pcap`.
![screen-shot-5](screen-shot-5.jpeg)
בתמונה הבאה ניתן לראות מצד שמאל את תוכן ההודעה שנשלחה ובכך אנו בטוחים שלכדנו את ההודעה הנכונה: !![screen-shot-6](screen-shot-6.jpeg)
### התעבורה שנלכדה
